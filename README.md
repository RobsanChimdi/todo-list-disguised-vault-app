# Secure Vault - Disguised Security App
...
1. **You'll see a Task Manager** - This is the disguise. It looks like a normal to-do list app.
2. **Decoy tasks are auto-created** - You'll see sample tasks like "Team meeting tomorrow", "Buy groceries", etc.
3. **To access the vault**, you need to create a PIN first.

### Creating Your PIN (First Time)

**Method 1: Via Lock Screen**
1. Open the app
2. On the lock screen, tap **"Create New PIN"**
3. Enter a 4-6 digit PIN (avoid easy sequences like 1234)
4. Confirm your PIN
5. (Optional) Add recovery email
6. Tap **"Complete Setup"**


### Accessing the Hidden Vault
